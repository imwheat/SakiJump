...
namespace GameBuild
{
    ...
    public class PatrolSet
    {
        ...
        public PatrolSet(GameObject obj)
        {
            this.obj = obj;
        }
    }
    ...
    public static explicit operator GridCoordinate(Vector3Int pos)
    {
    return new GridCoordinate(pos.x,pos.y);
    }
