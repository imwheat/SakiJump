...
namespace KFrame.UI
{
    [AddComponentMenu("KUI/DropdownTMP", 35)]
    ...
    /// </remarks>
    public class KDropdownTMP : KSelectable, IPointerClickHandler, ISubmitHandler, ICancelHandler
    {
        protected internal class DropdownItem : MonoBehaviour, IPointerEnterHandler, ICancelHandler
        {
            ...
            {
                KDropdownTMP dropdown = GetComponentInParent<KDropdownTMP>();
                if (dropdown)
                    dropdown.Hide();
            }
        }
        ...
        ///     KDropdownTMP.OptionData m_NewData, m_NewData2;
        ///     //The list of messages for the Dropdown
        ///     List<KDropdownTMP.OptionData> m_Messages = new List<KDropdownTMP.OptionData>();
        ///
        ///
        ///     //This is the Dropdown
        ///     KDropdownTMP m_Dropdown;
        ///     string m_MyString;
        ///     int m_Index;
        ///
        ///     void Start()
        ...
        ///             KDropdownTMP.OptionData temp = new KDropdownTMP.OptionData();
        ...
        ///     void DropdownValueChanged(KDropdownTMP change)
        ///     {
