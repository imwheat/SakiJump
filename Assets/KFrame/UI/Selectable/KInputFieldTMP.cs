...
namespace KFrame.UI
{
    [AddComponentMenu("KUI/KInputFieldTMP", 11)]
    public class KInputFieldTMP : KSelectable, 
        ...
        IScrollHandler
    {
        ...
        [SerializeField]
        private KInputFieldTMP.ContentType m_ContentType = KInputFieldTMP.ContentType.Standard;

        /// <summary>
        /// Type of data expected by the input field.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.InputType m_InputType = KInputFieldTMP.InputType.Standard;
        ...
        [SerializeField]
        private KInputFieldTMP.LineType m_LineType = KInputFieldTMP.LineType.SingleLine;
        ...
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.CharacterValidation m_CharacterValidation = KInputFieldTMP.CharacterValidation.None;
        ...
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.SubmitEvent m_OnEndEdit = new KInputFieldTMP.SubmitEvent();

        /// <summary>
        /// Event delegates triggered when the input field submits its data.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.SubmitEvent m_OnSubmit = new KInputFieldTMP.SubmitEvent();

        /// <summary>
        /// Event delegates triggered when the input field is focused.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.SelectionEvent m_OnSelect = new KInputFieldTMP.SelectionEvent();

        /// <summary>
        /// Event delegates triggered when the input field focus is lost.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.SelectionEvent m_OnDeselect = new KInputFieldTMP.SelectionEvent();

        /// <summary>
        /// Event delegates triggered when the text is selected / highlighted.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.TextSelectionEvent m_OnTextSelection = new KInputFieldTMP.TextSelectionEvent();

        /// <summary>
        /// Event delegates triggered when text is no longer select / highlighted.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.TextSelectionEvent m_OnEndTextSelection = new KInputFieldTMP.TextSelectionEvent();

        /// <summary>
        /// Event delegates triggered when the input field changes its data.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.OnChangeEvent m_OnValueChanged = new KInputFieldTMP.OnChangeEvent();

        /// <summary>
        /// Event delegates triggered when the status of the TouchScreenKeyboard changes.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.TouchScreenKeyboardEvent m_OnTouchScreenKeyboardStatusChanged = new KInputFieldTMP.TouchScreenKeyboardEvent();

        /// <summary>
        /// Custom validation callback.
        /// </summary>
        [SerializeField]
        private KInputFieldTMP.OnValidateInput m_OnValidateInput;
        ...
        public bool shouldHideMobileInput
        {
            ...
            set
            {
                switch(Application.platform)
                {
                    ...
                    case RuntimePlatform.IPhonePlayer:
                    case RuntimePlatform.tvOS:
                        UISetPropertyUtility.SetStruct(ref m_HideMobileInput, value);
                        break;
                    default:
        ...
        public bool shouldHideSoftKeyboard
        {
            ...
            set
            {
                switch (Application.platform)
                {
                    ...
                    #endif
                    case RuntimePlatform.Switch:
                        UISetPropertyUtility.SetStruct(ref m_HideSoftKeyboard, value);
                        break;
                    default:
        ...
        public float caretBlinkRate
        {
            ...
            set
            {
                if (UISetPropertyUtility.SetStruct(ref m_CaretBlinkRate, value))
                {
                    if (m_AllowInput)
                        SetCaretActive();
                }
        ...
        public int caretWidth { get { return m_CaretWidth; } set { if (UISetPropertyUtility.SetStruct(ref m_CaretWidth, value)) MarkGeometryAsDirty(); } }

        public RectTransform textViewport { get { return m_TextViewport; } set { UISetPropertyUtility.SetClass(ref m_TextViewport, value); } }
        ...
        public TMP_Text textComponent
        {
            ...
            set
            {
                if (UISetPropertyUtility.SetClass(ref m_TextComponent, value))
                {
                    SetTextComponentWrapMode();
                }
            }
        ...
        public Graphic placeholder { get { return m_Placeholder; } set { UISetPropertyUtility.SetClass(ref m_Placeholder, value); } }
        ...
        public Scrollbar verticalScrollbar
        {
            ...
            set
            {
                ...
                UISetPropertyUtility.SetClass(ref m_VerticalScrollbar, value);
        ...
        public float scrollSensitivity { get { return m_ScrollSensitivity; } set { if (UISetPropertyUtility.SetStruct(ref m_ScrollSensitivity, value)) MarkGeometryAsDirty(); } }

        public Color caretColor { get { return customCaretColor ? m_CaretColor : textComponent.color; } set { if (UISetPropertyUtility.SetColor(ref m_CaretColor, value)) MarkGeometryAsDirty(); } }
        ...
        public Color selectionColor { get { return m_SelectionColor; } set { if (UISetPropertyUtility.SetColor(ref m_SelectionColor, value)) MarkGeometryAsDirty(); } }

        public KInputFieldTMP.SubmitEvent onEndEdit { get { return m_OnEndEdit; } set { UISetPropertyUtility.SetClass(ref m_OnEndEdit, value); } }

        public KInputFieldTMP.SubmitEvent onSubmit { get { return m_OnSubmit; } set { UISetPropertyUtility.SetClass(ref m_OnSubmit, value); } }

        public KInputFieldTMP.SelectionEvent onSelect { get { return m_OnSelect; } set { UISetPropertyUtility.SetClass(ref m_OnSelect, value); } }

        public KInputFieldTMP.SelectionEvent onDeselect { get { return m_OnDeselect; } set { UISetPropertyUtility.SetClass(ref m_OnDeselect, value); } }

        public KInputFieldTMP.TextSelectionEvent onTextSelection { get { return m_OnTextSelection; } set { UISetPropertyUtility.SetClass(ref m_OnTextSelection, value); } }

        public KInputFieldTMP.TextSelectionEvent onEndTextSelection { get { return m_OnEndTextSelection; } set { UISetPropertyUtility.SetClass(ref m_OnEndTextSelection, value); } }

        public KInputFieldTMP.OnChangeEvent onValueChanged { get { return m_OnValueChanged; } set { UISetPropertyUtility.SetClass(ref m_OnValueChanged, value); } }

        public KInputFieldTMP.TouchScreenKeyboardEvent onTouchScreenKeyboardStatusChanged { get { return m_OnTouchScreenKeyboardStatusChanged; } set { UISetPropertyUtility.SetClass(ref m_OnTouchScreenKeyboardStatusChanged, value); } }

        public KInputFieldTMP.OnValidateInput onValidateInput { get { return m_OnValidateInput; } set { UISetPropertyUtility.SetClass(ref m_OnValidateInput, value); } }
        ...
        public int characterLimit
        {
            ...
            set
            {
                if (UISetPropertyUtility.SetStruct(ref m_CharacterLimit, Math.Max(0, value)))
                {
                    UpdateLabel();
                    if (m_SoftKeyboard != null)
        ...
        public float pointSize
        {
            ...
            set
            {
                if (UISetPropertyUtility.SetStruct(ref m_GlobalPointSize, Math.Max(0, value)))
                {
        ...
        public TMP_FontAsset fontAsset
        {
            ...
            set
            {
                if (UISetPropertyUtility.SetClass(ref m_GlobalFontAsset, value))
                {
        ...
        public KInputFieldTMP.ContentType contentType { get { return m_ContentType; } set { if (UISetPropertyUtility.SetStruct(ref m_ContentType, value)) EnforceContentType(); } }

        public KInputFieldTMP.LineType lineType
        {
            get { return m_LineType; }
            set
            {
                if (UISetPropertyUtility.SetStruct(ref m_LineType, value))
                {
                    SetToCustomIfContentTypeIsNot(KInputFieldTMP.ContentType.Standard, KInputFieldTMP.ContentType.Autocorrected);
                    SetTextComponentWrapMode();
                }
            }
        }
        ...
        public int lineLimit
        {
            ...
            set
            {
                if (m_LineType == KInputFieldTMP.LineType.SingleLine)
                    m_LineLimit = 1;
                else
                    UISetPropertyUtility.SetStruct(ref m_LineLimit, value);
        ...
        public KInputFieldTMP.InputType inputType { get { return m_InputType; } set { if (UISetPropertyUtility.SetStruct(ref m_InputType, value)) SetToCustom(); } }
        ...
        public TouchScreenKeyboardType keyboardType
        {
            ...
            set
            {
                if (UISetPropertyUtility.SetStruct(ref m_KeyboardType, value))
                    SetToCustom();
            }
        }

        public KInputFieldTMP.CharacterValidation characterValidation { get { return m_CharacterValidation; } set { if (UISetPropertyUtility.SetStruct(ref m_CharacterValidation, value)) SetToCustom(); } }
        ...
        public TMP_InputValidator inputValidator
        {
            ...
            set {  if (UISetPropertyUtility.SetClass(ref m_InputValidator, value)) SetToCustom(KInputFieldTMP.CharacterValidation.CustomValidator); }
        }
        [SerializeField]
        ...
        // Derived property
        public bool multiLine { get { return m_LineType == KInputFieldTMP.LineType.MultiLineNewline || lineType == KInputFieldTMP.LineType.MultiLineSubmit; } }
        // Not shown in Inspector.
        public char asteriskChar { get { return m_AsteriskChar; } set { if (UISetPropertyUtility.SetStruct(ref m_AsteriskChar, value)) UpdateLabel(); } }
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (!isFocused && m_SelectionStillActive)
            {
                ...
                if (selectedObject != null && selectedObject != this.gameObject)
                {
                    ...
                    if (selectedObject.GetComponent<KInputFieldTMP>() != null)
                        ReleaseSelection();
            ...
            if (m_Text != val)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < val.Length; ++i)
                    {
                        ...
                        else if (characterValidation != KInputFieldTMP.CharacterValidation.None)
                            c = Validate(m_Text, m_Text.Length, c);

                        if (lineType == KInputFieldTMP.LineType.MultiLineSubmit && c == '\n')
                        {
                            m_SoftKeyboard.text = m_Text;
        ...
        protected KInputFieldTMP.EditState KeyPressed(Event evt)
        {
            ...
            switch (evt.keyCode)
            {
                case KeyCode.Backspace:
                    {
                        Backspace();
                        return KInputFieldTMP.EditState.Continue;
                    }
                ...
                case KeyCode.C:
                    {
                        if (ctrlOnly)
                        {
                            if (inputType != KInputFieldTMP.InputType.Password)
                ...
                case KeyCode.KeypadEnter:
                    {
                        if (lineType != KInputFieldTMP.LineType.MultiLineNewline)
                        {
                            m_ReleaseSelection = true;
                            return KInputFieldTMP.EditState.Finish;
                        }
                        break;
                    }
        ...
        public virtual void OnUpdateSelected(BaseEventData eventData)
        {
            ...
            KInputFieldTMP.EditState shouldContinue;
            ...
            while (Event.PopEvent(m_ProcessingEvent))
            {
                ...
                switch (m_ProcessingEvent.rawType)
                {
                    ...
                    case EventType.KeyDown:
                        ...
                        if (shouldContinue == KInputFieldTMP.EditState.Finish)
                        {
                            if (!m_WasCanceled)
                                SendOnSubmit();
        ...
        protected virtual void Append(char input)
        {
            ...
            else if (characterValidation == KInputFieldTMP.CharacterValidation.CustomValidator)
            {
        ...
        protected char Validate(string text, int pos, char ch)
        {
            ...
            if (characterValidation == KInputFieldTMP.CharacterValidation.None || !enabled)
                return ch;

            if (characterValidation == KInputFieldTMP.CharacterValidation.Integer || characterValidation == KInputFieldTMP.CharacterValidation.Decimal)
            {
                // Integer and decimal
                ...
                if (!cursorBeforeDash)
                {
                    ...
                    if (ch == Convert.ToChar(separator) && characterValidation == KInputFieldTMP.CharacterValidation.Decimal && !text.Contains(separator)) return ch;
                }
            }
            else if (characterValidation == KInputFieldTMP.CharacterValidation.Digit)
            {
                if (ch >= '0' && ch <= '9') return ch;
            }
            else if (characterValidation == KInputFieldTMP.CharacterValidation.Alphanumeric)
            {
            ...
            else if (characterValidation == KInputFieldTMP.CharacterValidation.Name)
            {
            ...
            else if (characterValidation == KInputFieldTMP.CharacterValidation.EmailAddress)
            {
            ...
            else if (characterValidation == KInputFieldTMP.CharacterValidation.Regex)
            {
                // Regex expression
        ...
        private void ActivateInputFieldInternal()
        {
            ...
            if (TouchScreenKeyboard.isSupported && shouldHideSoftKeyboard == false)
            {
                ...
                {
                    m_SoftKeyboard = (inputType == KInputFieldTMP.InputType.Password) ?
                        TouchScreenKeyboard.Open(m_Text, keyboardType, false, multiLine, true, false, "", characterLimit) :
                        TouchScreenKeyboard.Open(m_Text, keyboardType, inputType == KInputFieldTMP.InputType.AutoCorrect, multiLine, false, false, "", characterLimit);
        ...
        private void EnforceContentType()
        {
            switch (contentType)
            {
                case KInputFieldTMP.ContentType.Standard:
                    {
                        // Don't enforce line type for this content type.
                        m_InputType = KInputFieldTMP.InputType.Standard;
                        m_KeyboardType = TouchScreenKeyboardType.Default;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.None;
                        break;
                    }
                case KInputFieldTMP.ContentType.Autocorrected:
                    {
                        // Don't enforce line type for this content type.
                        m_InputType = KInputFieldTMP.InputType.AutoCorrect;
                        m_KeyboardType = TouchScreenKeyboardType.Default;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.None;
                        break;
                    }
                case KInputFieldTMP.ContentType.IntegerNumber:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Standard;
                        m_KeyboardType = TouchScreenKeyboardType.NumberPad;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.Integer;
                        break;
                    }
                case KInputFieldTMP.ContentType.DecimalNumber:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Standard;
                        m_KeyboardType = TouchScreenKeyboardType.NumbersAndPunctuation;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.Decimal;
                        break;
                    }
                case KInputFieldTMP.ContentType.Alphanumeric:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Standard;
                        m_KeyboardType = TouchScreenKeyboardType.ASCIICapable;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.Alphanumeric;
                        break;
                    }
                case KInputFieldTMP.ContentType.Name:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Standard;
                        m_KeyboardType = TouchScreenKeyboardType.Default;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.Name;
                        break;
                    }
                case KInputFieldTMP.ContentType.EmailAddress:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Standard;
                        m_KeyboardType = TouchScreenKeyboardType.EmailAddress;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.EmailAddress;
                        break;
                    }
                case KInputFieldTMP.ContentType.Password:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Password;
                        m_KeyboardType = TouchScreenKeyboardType.Default;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.None;
                        break;
                    }
                case KInputFieldTMP.ContentType.Pin:
                    {
                        m_LineType = KInputFieldTMP.LineType.SingleLine;
                        m_InputType = KInputFieldTMP.InputType.Password;
                        m_KeyboardType = TouchScreenKeyboardType.NumberPad;
                        m_CharacterValidation = KInputFieldTMP.CharacterValidation.Digit;
                        break;
                    }
                default:
                    {
        ...
        void SetToCustomIfContentTypeIsNot(params KInputFieldTMP.ContentType[] allowedContentTypes)
        {
            if (contentType == KInputFieldTMP.ContentType.Custom)
                return;
            ...
            contentType = KInputFieldTMP.ContentType.Custom;
        }
        ...
        void SetToCustom(KInputFieldTMP.CharacterValidation characterValidation)
        {
            if (contentType == KInputFieldTMP.ContentType.Custom)
            {
                characterValidation = KInputFieldTMP.CharacterValidation.CustomValidator;
                return;
            }
