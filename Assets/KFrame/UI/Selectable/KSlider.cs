...
namespace KFrame.UI
{
    [AddComponentMenu("KUI/Slider", 37)]
    public class KSlider : KSelectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
